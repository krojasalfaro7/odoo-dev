...
class CrytoController(http.Controller):
    _notify_url = '/payment/glufco/ipn/'
    _return_url = '/payment/glufco/dpn/'
    _cancel_url = '/payment/glufco/cancel/'
    ...
    @http.route('/payment/glufco/ipn/', type='http', auth='none', methods=['POST'], csrf=False)
    ...
    @http.route('/payment/glufco/dpn', type='http', auth="none", methods=['POST', 'GET'], csrf=False)
    ...
    @http.route('/payment/glufco/cancel', type='http', auth="none", csrf=False)
